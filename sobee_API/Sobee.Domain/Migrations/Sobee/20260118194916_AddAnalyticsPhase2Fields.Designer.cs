...
namespace Sobee.Domain.Migrations.Sobee
{
    ...
    [Migration("20260118194916_AddAnalyticsPhase2Fields")]
    partial class AddAnalyticsPhase2Fields
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Sobee.Domain.Entities.Cart.TcartItem", b =>
                {
                    ...
                    b.HasIndex("IntShoppingCartId", "IntProductId")
            ...
            modelBuilder.Entity("Sobee.Domain.Entities.Orders.Torder", b =>
                {
                    ...
                    b.Property<decimal?>("DecDiscountAmount")
                    ...
                    b.Property<decimal?>("DecSubtotalAmount")
                        .HasColumnType("decimal(18,2)")
                    ...
                    b.Property<DateTime?>("DtmShippedDate")
                        .HasColumnType("datetime")
            ...
            modelBuilder.Entity("Sobee.Domain.Entities.Products.TproductImage", b =>
                {
                    ...
                    b.HasIndex("IntProductId")
                        .HasDatabaseName("IX_TProductImages_intProductID");
            ...
            modelBuilder.Entity("Sobee.Domain.Entities.Reviews.Tfavorite", b =>
                {
                    ...
                    b.HasIndex("UserId", "IntProductId")
                        .IsUnique()
            ...
            modelBuilder.Entity("Sobee.Domain.Entities.Products.Tproduct", b =>
                {
                    b.HasOne("Sobee.Domain.Entities.Products.TdrinkCategory", "IntDrinkCategory")
                        .WithMany("Tproducts")
                        .HasForeignKey("IntDrinkCategoryId")
                        .OnDelete(DeleteBehavior.SetNull)
                        .HasConstraintName("TProducts_TDrinkCategories_FK");

                    b.Navigation("IntDrinkCategory");
                });
