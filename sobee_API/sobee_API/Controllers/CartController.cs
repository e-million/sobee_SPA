...
namespace sobee_API.Controllers
{
    ...
    public class CartController : ControllerBase
    {
        ...
        public async Task<IActionResult> AddItem([FromBody] AddCartItemRequest request)
        {
            ...
            if (product == null)
                return NotFoundError($"Product {request.ProductId} not found.", "NotFound");
        ...
        public async Task<IActionResult> ApplyPromo([FromBody] ApplyPromoRequest request)
        {
            ...
            if (alreadyApplied)
                return ConflictError("Promo code already applied to this cart.", "Conflict");
        ...
        public async Task<IActionResult> UpdateItem(int cartItemId, [FromBody] UpdateCartItemRequest request)
        {
            ...
            if (item == null)
                return NotFoundError($"Cart item {cartItemId} not found.", "NotFound");
            ...
            else
            {
                ...
                if (product == null)
                    return NotFoundError($"Product {item.IntProductId} not found.", "NotFound");
